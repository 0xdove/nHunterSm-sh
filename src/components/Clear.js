        ...
        <View style={styles.startPanel}>
          ...
          <View style={styles.scoreContainer}>
            <Image
              ...
              resizeMode="contain"
              source={IMAGES.hunterIcon}
            />
            <Text style={styles.regularText}>
              {hunterHit}/{hunterPopped}
            </Text>
          </View>
          <View style={styles.scoreContainer}>
            <Image
          ...
          <View style={styles.scoreContainer}>
            <Image
              style={styles.scoreIcon}
              resizeMode="contain"
              source={IMAGES.boarIcon}
            />
            <Text
              style={[
                styles.regularText,
                // eslint-disable-next-line react-native/no-inline-styles
                boarHit === 0 ? {color: 'green'} : {color: 'red'},
              ]}>
              {boarHit}/{boarPopped}
            </Text>
          </View>
          <Text style={styles.panelText}>
            {translate('levelScore')}:{' '}
            {hunterHit * ActorPoints.HUNTER +
              bossHit * ActorPoints.BOSS +
              boarHit * ActorPoints.BOAR}
          </Text>
          <TouchableOpacity onPress={this.props.onReset}>
            <View
              style={[
                styles.startButton,
                {backgroundColor: 'tomato', borderColor: 'white'},
              ]}>
              <Image
